...
class UpdateProfileCustomer extends StatefulWidget {
  ...
  const UpdateProfileCustomer({Key? key,required this.userId,required this.token,required this.type}) : super(key: key);

  @override
  State<UpdateProfileCustomer> createState() => _UpdateProfileCustomer();
}

class _UpdateProfileCustomer extends State<UpdateProfileCustomer> {
